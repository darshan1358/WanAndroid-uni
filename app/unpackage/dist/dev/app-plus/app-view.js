...
var x=['./pages/account/account.wxml','./pages/detailPage/detailPage.wxml','./pages/favorite/favorite.wxml','./pages/index/index.wxml','./pages/login/login.wxml','./pages/mine/mine.wxml','./pages/project/project.wxml','./pages/register/register.wxml','./pages/search/search.wxml','./pages/setting/setting.wxml','./pages/system/system.wxml'];d_[x[0]]={}
...
var cI=_mz(z,'swiper',['autoplay',1,'class',1,'indicatorColor',2,'indicatorDots',3],[],e,s,gg)
var oJ=_v()
_(cI,oJ)
var lK=function(tM,aL,eN,gg){
var oP=_n('swiper-item')
_rz(z,oP,'class',9,tM,aL,gg)
var xQ=_mz(z,'image',['mode',10,'src',1,'style',2],[],tM,aL,gg)
_(oP,xQ)
_(eN,oP)
return eN
}
...
var oX=_mz(z,'view',['bindtap',17,'class',1,'data-event-opts',2],[],hU,cT,gg)
var lY=_n('view')
_rz(z,lY,'class',20,hU,cT,gg)
var aZ=_oz(z,21,hU,cT,gg)
_(lY,aZ)
_(oX,lY)
var t1=_n('view')
_rz(z,t1,'class',22,hU,cT,gg)
var e2=_oz(z,23,hU,cT,gg)
_(t1,e2)
_(oX,t1)
_(oV,oX)
return oV
...
__wxAppCode__['pages/account/account.wxss']=undefined;    
...
__wxAppCode__['pages/system/system.wxss']=undefined;    
